...
class CacheLayoutTest extends Specification {
    ...
    def "use metadata store layout"() {
        ...
        then:
        cacheLayout.key == 'metadata-2.41'
        cacheLayout.version == VersionNumber.parse("2.41.0")
        cacheLayout.formattedVersion == '2.41'
        cacheLayout.getPath(new File('some/dir')) == new File('some/dir/metadata-2.41')
    }
